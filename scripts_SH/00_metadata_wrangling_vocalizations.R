...
f_meta <- list.files("../Vocalization study participants answers/all 200 answers/", recursive = T, pattern = "trials.csv", full.names = T)
f_meta2 <- list.files("../Vocalization study participants answers/all 200 answers/", recursive = T, pattern = "sessions.csv", full.names = T)
...
# write_xlsx(metadata, "all_metadata.xlsx")
