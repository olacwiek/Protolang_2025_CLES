...
vocs <- read_xlsx("helpers/all_vocs.xlsx")

# all apes (full list created in 02_iaa.qmd)
apes <- read_xlsx("helpers/all_apes.xlsx")

# mismatches and final decisions
mismatches_vocs <- read_xlsx("../Coders/Mismatches/Mismatches.xlsx", sheet = "Vocalizations")
mismatches_apes <- read_xlsx("../Coders/Mismatches/Mismatches.xlsx", sheet = "Apes")
...
# replace multiple whitespaces because there are some mismatches
# between the mismatches sheet and the original data (maybe accidentally
# someone used a data cleanup function in Excel or Googledocs....)
...
# export
# write_xlsx(vocs, "final_decisions/vocs.xlsx")
...
# export
# write_xlsx(apes, "final_decisions/apes.xlsx")
