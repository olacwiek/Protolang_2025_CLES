...
f_meta <- list.files("../data_raw/Ape study participants answers/", recursive = T, pattern = "trials.csv", full.names = T)
f_meta2 <- list.files("../data_raw/Ape study participants answers/", recursive = T, pattern = "sessions.csv", full.names = T)
...
# write_xlsx(metadata, "../metadata/all_metadata_apes.xlsx")
