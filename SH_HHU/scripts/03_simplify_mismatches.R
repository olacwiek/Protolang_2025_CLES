...
# read data
apes <- read_xlsx("../data_annotated/helpers/mismatches/Mismatches.xlsx", sheet = "Apes")
vocs <- read_xlsx("../data_annotated/helpers/mismatches/Mismatches.xlsx", sheet = "Vocalizations")
